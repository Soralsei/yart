...
set(main_sources src/main.cpp ${sources})

set(clock_sources src/clock.cpp ${sources})
set(trajectory_sources src/trajectory.cpp ${sources})
set(projection_sources src/projection.cpp ${sources})
set(shading_sources src/shaded_sphere.cpp ${sources})
set(render_sources src/world_render.cpp ${sources})
set(plane_render_sources src/plane_render.cpp ${sources})
